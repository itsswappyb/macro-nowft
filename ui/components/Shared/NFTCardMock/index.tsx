    ...
    return (
        <div className="p-4 w-full md:w-1/2 lg:px-4 lg:w-1/3 transition ease-in-out hover:scale-105">
            <Link href="/nft">
                <article
                    className={clsx(
                        "container overflow-hidden rounded-3xl shadow-lg p-6 hover:cursor-pointer hover:shadow-xl",
                        listed && "bg-gray-800",
                        !listed && "bg-gray-700"
                    )}
                >
                    ...
                    <div className="flex justify-between max-w-sm">
                        ...
                        {listed ? (
                            ...
                            <div className="pt-2 text-xl font-bold text-spritzig">Unlisted</div>
                        )}
                    </div>
                    {listed && (
                        <div>
